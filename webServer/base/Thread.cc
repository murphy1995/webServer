...
void afterFork()
{
  webServer::CurrentThread::t_cachedTid = 0;
...
struct ThreadData
{
  typedef webServer::Thread::ThreadFunc ThreadFunc;
  ThreadFunc func_;
  string name_;
  pid_t* tid_;
  ...
  void runInThread()
  {
    *tid_ = webServer::CurrentThread::tid();
    tid_ = NULL;
    latch_->countDown();
    latch_ = NULL;
    ...
    {
      webServer::CurrentThread::t_threadName = "crashed";
